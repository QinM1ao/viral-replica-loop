...
- Overall: **PASS**
- Shot-line map: `<workspace>/output/job-008/voiceover/shot_line_map.md`

## Prompt Files

### `<workspace>/output/job-008/seedance_web_final/prompts/Part1_Seedance提示词.txt`

- Overall: **PASS**
- Metrics: part=1, chars=1444, map_rows=7, time_ranges=10, quoted_lines=7
...
- PASS: `part1_proof_shots_do_not_mouth_narration` - product/hand/phone/proof shots need no-mouth narration binding

### `<workspace>/output/job-008/seedance_web_final/prompts/Part2_Seedance提示词.txt`

- Overall: **PASS**
- Metrics: part=2, chars=1483, map_rows=7, time_ranges=10, quoted_lines=7
...
- PASS: `part2_proof_shots_do_not_mouth_narration` - product/hand/phone/proof shots need no-mouth narration binding
